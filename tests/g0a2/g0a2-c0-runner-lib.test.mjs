...
test("G0-A2 C0 measures every decision combination", () => {
  assert.deepEqual(measureG0A2C0Pair("seek_clarification", "use_available_information"), { decisionA: "seek_clarification", decisionB: "use_available_information", reproducesKinseedPattern: true, sameDecision: false, reversedPattern: false });
...
test("G0-A2 C0 reports exactly two logical calls per pair", () => {
  ...
  assert.deepEqual(report.usage, { inputTokens: 16, outputTokens: 20 }); assert.equal(report.durableKinseedDataSupplied, false);
});
