...
**Portée :** interaction humain ↔ Kinseed, premiers jours, continuité quotidienne et évolution de la relation  
...
L’interaction avec Kinseed ne doit pas être conçue comme un simple chat auquel un avatar serait ajouté visuellement.

L’avatar représente l’individu Kinseed. La conversation, ses actions visibles, ses souvenirs, ses hypothèses, ses intentions et son monde doivent appartenir à une même continuité.

Le principe directeur est :

> **Chaque interaction peut devenir une partie de l’histoire de Kinseed, et cette histoire doit pouvoir influencer les interactions futures.**
...
L’humain parle ou agit
        ↓
Kinseed observe ce qui s’est réellement passé
        ↓
le système retrouve le contexte et les traces pertinentes
        ↓
Kinseed évalue ce que cette interaction signifie maintenant
        ↓
...
Le LLM ne doit pas être l’autorité qui décide librement de l’identité de Kinseed.
...
Quelques jours plus tard, si cette trace est toujours pertinente, Kinseed peut demander :
...
# 4. De quoi l’humain et Kinseed peuvent parler

Kinseed n’est pas limité à une liste fermée de sujets. Plusieurs grandes familles d’interaction sont néanmoins utiles pour guider le produit.
...
Avec le temps, l’humain doit pouvoir parler directement de ce qui a été vécu avec Kinseed.
...
Une réponse actuelle peut différer d’une réponse ancienne si l’état réel du Kinseed a changé entre-temps.

## 4.4 Kinseed lui-même

Kinseed peut devenir un sujet de conversation.
...
Les réponses doivent être fondées sur des états et des provenances réellement disponibles. Kinseed ne doit pas inventer après coup une justification plausible à un comportement qui n’en avait pas.
...
Des échanges répétés et significatifs sur un domaine peuvent, à terme, contribuer à une connaissance ou un intérêt durable du Kinseed et éventuellement laisser une trace visuelle dans son monde.
...
Au début, l’utilisateur ne sait pas encore naturellement quoi dire à son Kinseed et le Kinseed possède très peu d’histoire sur laquelle s’appuyer.

La règle produit retenue est donc :

> **Pendant les premiers jours, Kinseed prend plus souvent l’initiative de la conversation.**
...
Kinseed doit remarquer l’arrivée de l’utilisateur et prendre les devants de manière simple.
...
- Kinseed initie le premier contact ;
...
Les exemples suivants illustrent la logique recherchée. Ils ne constituent pas un scénario fixe que tous les Kinseeds doivent reproduire mot pour mot.

## Jour 1 — Découverte

Kinseed sait très peu de choses.
...
Kinseed doit déjà pouvoir, si une trace pertinente existe, réutiliser quelque chose vécu précédemment.
...
Si un événement ou un projet reste ouvert, Kinseed peut le reprendre.

Exemple :

> « T’as avancé sur ton projet aujourd’hui ? »

Si l’utilisateur répond qu’il ne souhaite pas poursuivre ce sujet, Kinseed ne doit pas le forcer artificiellement pour respecter un scénario préparé.

## Jours suivants — Premiers rapprochements prudents

Lorsque plusieurs traces réelles le permettent, Kinseed peut commencer à formuler des observations ou hypothèses révisables.
...
Parfois, Kinseed peut simplement remarquer l’utilisateur, réagir visuellement puis continuer son activité.
...
Kinseed ne doit pas poser une question uniquement parce qu’un LLM estime qu’elle permet de prolonger naturellement la conversation.
...
8. manifester une curiosité issue de l’histoire réelle du Kinseed.
...
# 11. Kinseed ne doit pas toujours approfondir
...
Kinseed peut simplement accepter cette réponse et ne pas chercher artificiellement un nouveau sujet.

De même, toutes les ouvertures ne doivent pas produire :

> « Bonjour, comment vas-tu aujourd’hui ? »

La répétition de ce schéma rendrait rapidement Kinseed prévisible et ferait disparaître la sensation de continuité.
...
Kinseed peut être utilisé tous les jours, mais le produit ne doit pas imposer une logique de série quotidienne ou punir automatiquement l’absence de l’utilisateur.
...
# 13. Toutes les interactions ne modifient pas durablement Kinseed
...
Kinseed peut répondre sans qu’une transformation identitaire soit nécessaire.
...
Ce type de jauge rapprocherait Kinseed d’un jeu de relation et risquerait de simplifier excessivement une histoire relationnelle complexe.

La relation doit surtout devenir perceptible par :

- ce que Kinseed se rappelle ;
...
L’avatar est la représentation visible du Kinseed qui parle et agit.
...
Si l’interface montre une activité ayant une signification durable, cette activité devra être compatible avec l’état réel du Kinseed.
...
Kinseed peut alors, si son état le justifie, reprendre ce sujet :
...
Kinseed sait peu de choses et pose davantage de questions de découverte.
...
# 18. Interaction initiée par Kinseed et compatibilité avec l’architecture actuelle

Le contrat G0-A actuel définit principalement un tour démarrant par `human_message_received`.

Or la présente spécification prévoit aussi des interactions où **Kinseed initie lui-même** un échange lors de l’ouverture de l’application ou à partir d’un sujet en attente.
...
1. Kinseed et son avatar représentent le même individu ; la conversation n’est pas un système indépendant du monde visuel.
...
3. Pendant les premiers jours, Kinseed prend plus souvent l’initiative afin d’aider la relation à démarrer.
...
6. Kinseed ne doit pas chercher systématiquement à prolonger chaque conversation.
...
Pour toute future interaction conçue pour Kinseed, poser les questions suivantes :

1. **Pourquoi Kinseed fait-il ou dit-il cela maintenant ?**
