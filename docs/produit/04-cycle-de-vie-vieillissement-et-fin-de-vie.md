...
Cette transmission devra respecter les règles fondatrices de `docs/09-regles-fondatrices-heritage.md` : le descendant reste un nouvel individu et n’hérite jamais de l’état complet du parent.
