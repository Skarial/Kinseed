...
Le graphisme de Kinseed ne doit pas servir uniquement à décorer l’application.
...
Le monde visuel doit donc pouvoir montrer, avec le temps, des traces de ce que le Kinseed a vécu, appris, construit, perdu, transformé ou hérité.
...
- le petit personnage ou animal très cartoon, qui rapprocherait trop Kinseed d’un Tamagotchi ou d’un jeu pour enfant.
...
- suffisamment distinctif pour permettre à chaque Kinseed de devenir reconnaissable dans le temps.

L’avatar et le monde doivent former une scène cohérente : le Kinseed est présent dans son environnement personnel, et cet environnement peut évoluer avec son histoire.

---

## 3. Sexe visuel choisi par l’utilisateur

À la création du premier Kinseed, l’utilisateur choisit uniquement entre deux bases visuelles :
...
Tous les Kinseeds commencent dans **le même type d’environnement de base**.
...
Si chaque monde était déjà totalement différent au départ, il deviendrait difficile de distinguer ce qui appartient à la génération initiale de ce qui résulte réellement de l’histoire du Kinseed.
...
Ces variations servent à éviter une uniformité absolue, mais elles ne doivent pas donner l’impression que le Kinseed possède déjà une longue histoire.
...
> **Un changement durable et significatif dans le monde doit correspondre à quelque chose de réellement arrivé dans l’histoire du Kinseed.**
...
Ainsi, si un télescope apparaît plusieurs mois plus tard, sa présence signifie quelque chose dans l’histoire du Kinseed.
...
Cette évolution doit être cohérente avec l’évolution réelle du Kinseed.
...
Pour rester compatible avec les principes d’architecture de Kinseed, une trace visuelle importante doit pouvoir être reliée à sa provenance.
...
Certains objets auront cependant une fonction interactive forte : ils pourront servir de **portes d’entrée vers une partie de la vie du Kinseed**.
...
- **objets-expérience** : ouvrent une petite expérience spécifique liée au monde ou aux intérêts du Kinseed.
...
L’idée retenue est que **chaque livre important puisse représenter un domaine de connaissance réellement développé par le Kinseed**.
...
Le détail exact du contenu reste à spécifier, mais une structure cohérente avec l’architecture de Kinseed devra préserver la distinction entre :

- **connaissances acquises** ;
- **interprétations, opinions ou hypothèses du Kinseed** ;
...
Annotations personnelles du Kinseed
...
Un emplacement peut donc être vide tant que cette relation ou cette partie de l’histoire n’existe pas, puis être occupé si la vie du Kinseed évolue dans cette direction.

### Point à ne pas figer trop tôt

L’album ne doit pas imposer artificiellement à tous les Kinseeds un parcours de vie prédéfini.
...
S’il existe réellement dans le monde d’un Kinseed, l’utilisateur peut cliquer dessus et accéder à une vue dédiée du ciel étoilé.

Cette vue peut devenir une petite expérience immersive associée à l’intérêt ou à l’histoire du Kinseed.
...
6. Tous les Kinseeds commencent dans le même type de **petit refuge sobre**, avec seulement quelques variations initiales mineures.
...
9. Le monde n’est pas une archive infinie : les traces peuvent rester, évoluer, être déplacées, rangées ou disparaître selon leur importance et l’évolution réelle du Kinseed.
...
> **Ce que l’utilisateur voit dans le monde de son Kinseed raconte-t-il réellement quelque chose de cet individu et de son histoire, ou s’agit-il seulement de décoration ?**

Si un élément n’apporte rien à l’identité, au vécu, à la relation, à l’apprentissage ou à la continuité du Kinseed, sa complexité doit être justifiée par un autre besoin produit concret.
