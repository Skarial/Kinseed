# Kinseed — État de l’art

## Statut du document

**Type :** document de recherche, distinct de la documentation d’architecture et des spécifications numérotées de Kinseed.  
**Dernière vérification :** 10 août 2026.  
**Statut :** version initiale, à compléter au fil du projet.

Ce document a pour objectif de situer Kinseed par rapport aux travaux, systèmes et produits déjà existants ou proches de sa direction de recherche.
...
La documentation d’architecture de Kinseed reste séparée de ce document.

---

# 1. Question étudiée

Kinseed cherche à construire un **individu numérique persistant** dont l’identité ne correspond pas simplement à un prompt de personnalité ou à l’état temporaire d’un modèle de langage.
...
Kinseed sépare conceptuellement :
...
Une différence avec Kinseed apparaît dans les sources disponibles, mais elle devra être vérifiée plus largement.

## Inconnu

Aucune conclusion solide ne peut encore être formulée.

Cet état de l’art **n’est pas exhaustif**. Il ne constitue donc pas une preuve de nouveauté scientifique ou juridique de Kinseed.
...
Kinseed cherche volontairement à réduire au minimum l’identité préécrite de la génération 0. Une personnalité ou une biographie configurée par l’utilisateur avant l’existence du compagnon est précisément un mécanisme que Kinseed cherche à éviter pour ses propriétés centrales.
...
La persistance de mémoire ne constitue pas automatiquement une théorie de l’identité. Kinseed doit donc éviter d’assimiler « se souvenir de l’historique » à « posséder une identité construite par l’histoire ».
...
Le fait que la persona de l’agent puisse être reconstruite ou mise à jour à partir de l’historique est directement pertinent pour Kinseed.

### Différence à vérifier

LD-Agent vise principalement la qualité du dialogue personnalisé. Kinseed impose des contraintes supplémentaires sur l’origine des traits, la séparation entre déclaration linguistique et état durable, ainsi que la causalité des décisions.
...
La persona reste ici principalement un mécanisme de personnalisation et d’alignement envers l’utilisateur. Kinseed cherche à permettre une distinction réelle entre :

- ce que l’humain préfère ;
- ce que l’humain croit ;
- ce que le Kinseed apprend à préférer ;
- ce que le Kinseed apprend à croire.
...
### Importance pour Kinseed

Ce travail renforce l’idée qu’une mémoire structurée est plus pertinente qu’une accumulation intégrale de conversations.

Il constitue aussi un avertissement : une partie de ce que Kinseed pourrait appeler « continuité » peut déjà être obtenue par des mécanismes relativement classiques de mémoire et de récupération. Les expériences de Kinseed devront donc démontrer ce que son architecture apporte au-delà de cette amélioration conversationnelle.
...
L’unité principalement accumulée par Voyager est la **compétence utile**. Kinseed cherche en plus des transformations durables concernant identité, préférences, croyances, valeurs, relations et objectifs.
...
L’objectif principal reste l’amélioration des capacités et des compétences de l’agent. Kinseed s’intéresse à la formation d’un individu et à la continuité de son identité, ce qui constitue une question différente même si les mécanismes peuvent se recouvrir.
...
**Memory as Ontology: A Constitutional Memory Architecture for Persistent Digital Citizens** est l’un des travaux actuellement identifiés comme les plus proches de certains principes centraux de Kinseed.
...
### Ressemblance forte avec Kinseed

Kinseed affirme lui aussi que :
...
Kinseed ajoute des questions spécifiques qui ne constituent pas le centre du papier Animesis :
...
**OpenLife: Toward Open-World Artificial Life with Autonomous LLM Agents** constitue une autre référence particulièrement importante pour Kinseed.
...
Kinseed se concentre initialement sur une relation individuelle humain ↔ Kinseed et sur la construction contrôlée d’une identité personnelle. OpenLife étudie davantage des agents autonomes placés dans un monde ouvert et social.

Aucune transmission intergénérationnelle comparable au modèle actuellement prévu par Kinseed n’a été identifiée dans ce travail.
...
Kinseed ne doit donc pas présenter la reproduction numérique comme une idée nouvelle en elle-même.
...
Avida représente une référence méthodologique importante si Kinseed introduit ultérieurement des mécanismes de variation héréditaire.
...
La spécificité éventuelle de Kinseed ne peut donc pas être « des créatures numériques font des enfants ».
...
Le vocabulaire et certains mécanismes de recombinaison peuvent sembler proches de la future reproduction des Kinseeds.
...
Kinseed prévoit autre chose : le LLM sous-jacent peut rester un moteur remplaçable tandis que le descendant reçoit un patrimoine constitutif et culturel provenant d’individus numériques persistants.
...
| **Kinseed visé** | **Oui** | **Oui** | **Oui** | **Progressivement** | **Prévue** | **Prévue** | **Oui, principe central** |
...
À ce stade, les éléments suivants **ne doivent pas être présentés comme des inventions de Kinseed pris isolément** :
...
# 14. Ce qui paraît actuellement plus spécifique à Kinseed

À partir des sources examinées jusqu’au 10 août 2026, l’intérêt potentiel de Kinseed semble se situer moins dans une brique isolée que dans la **combinaison expérimentale** des contraintes suivantes :
...
Kinseed cherche à distinguer explicitement :
...
La question spécifique de Kinseed est plutôt de déterminer si **l’identité historiquement construite** reste suffisamment stable et causalement active après le remplacement du moteur linguistique.

## 14.6 Transmission intergénérationnelle multi-couche

Le futur système d’héritage de Kinseed prévoit de distinguer :
...
L’ordre de priorité actuel pour la veille scientifique de Kinseed est le suivant.
...
Kinseed devra être particulièrement prudent face à plusieurs confusions possibles.
...
Le critère important pour Kinseed doit rester la présence d’un mécanisme testable, et non l’impression subjective produite par la conversation.
...
7. Comment la recherche sur l’open-ended evolution peut-elle éviter la convergence des lignées Kinseed vers des profils moyens ?
...
# 18. Positionnement provisoire de Kinseed

**Certain :** la plupart des briques techniques envisagées par Kinseed existent déjà séparément dans plusieurs domaines de recherche.
...
**Certain :** certains travaux de 2026, notamment OpenLife et Animesis, se rapprochent fortement de plusieurs idées centrales de Kinseed.

**Probable :** l’intérêt expérimental de Kinseed se trouve dans la manière dont il combine formation progressive d’identité, causalité traçable, séparation du LLM, relation humaine, évolution sur le temps long et futur héritage intergénérationnel.
...
> **Kinseed explore une combinaison particulière de mécanismes déjà partiellement présents dans plusieurs champs. Le projet doit démontrer expérimentalement ce que cette combinaison produit de plus que les architectures existantes, plutôt que supposer sa nouveauté.**
...
Chaque fois qu’un nouveau mécanisme important est envisagé pour Kinseed, avant de le considérer comme potentiellement original :
...
6. modifier le positionnement de Kinseed si une antériorité plus proche est découverte.

Un état de l’art utile n’est pas un document destiné à défendre le projet.

Il doit être capable de montrer que certaines idées de Kinseed existaient déjà avant lui et d’obliger le projet à préciser ce qu’il cherche réellement à apporter.