...
Les mécanismes d’héritage intergénérationnel sont définis séparément dans `docs/11-regles-fondatrices-heritage.md` et ne doivent pas être utilisés pour préremplir l’identité de la génération 0.
