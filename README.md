...
13. [`docs/13-generation-0a3-protocole-memoire-episodique-minimale.md`](docs/13-generation-0a3-protocole-memoire-episodique-minimale.md) — définit le protocole G0-A3 consacré à la création, la récupération, l’influence et la révision d’une mémoire épisodique minimale.
14. [`docs/14-generation-0a3-contrat-implementation.md`](docs/14-generation-0a3-contrat-implementation.md) — fixe les structures, invariants, checkpoints, reprises et tests déterministes requis avant l’implémentation de G0-A3.
15. [`docs/15-regles-fondatrices-heritage.md`](docs/15-regles-fondatrices-heritage.md) — conserve les règles déjà validées pour la future transmission intergénérationnelle.
...
- Le protocole et le contrat d’implémentation G0-A3 sont définis ; G0-A3 n’est ni implémenté ni validé.
- G0-A reste ouvert.
